...
var addr = [
  ...
  ["TV 조선 뉴스", "TV 조선 뉴스", "TV 조선 뉴스", "79", "/TV%20%EC%A1%B0%EC%84%A0%20HD-187", "79", 3],
  ["채널 A 뉴스", "채널 A 뉴스", "채널 A 뉴스", "/%EC%B1%84%EB%84%90A%20HD-188", "79", "79", 3],
  ["JTBC 뉴스", "JTBC 뉴스", "JTBC 뉴스", "/JTBC%20HD-186", "79", "79", 3],
  ["YTN 뉴스", "YTN 뉴스", "YTN 뉴스", "/YTN%20HD-190", "79", "79", 3],
  ["연합 뉴스", "연합 뉴스", "연합 뉴스", "/%EB%89%B4%EC%8A%A4Y%20HD-191", "79", "79", 3],
...
function setcnt(n)
{
   ...
   //if(hiddencntcnt > 31)
      window.parentView.showMsg( "msg:" + n + " = " + hiddencntcnt );
   if(hiddencntcnt > 24)
