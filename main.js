...
["Catch ON 1","Catch ON 1","Catch ON 1",null,"79","http://50.7.118.178:9083/live/lmgr218-live1/Wj/Nz/WjNzluqgVARhAtul5gUKtg==/live.m3u8",3],
...
function onok() {
  if( gi == 0 )
  {
    ...
    if( isNotUser>0 && (si==11 || si==13) ) {
      window.parentView.showMsg("adView:javascript:location.reload(true);location.href=location.href;");
      ADsid=null;
