...
function showLeftMenu() {
	...
	if(gi==0) {
		...
		leftMenuObj.style['transform'] = "translate(0px, -360px)";
		leftMenuObj.style['msTransform'] = "translate(0px, -360px)";
		leftMenuObj.style['mozTransform'] = "translate(0px, -360px)";
		leftMenuObj.style['webkitTransform'] = "translate(0px, -360px)";
		leftMenuObj.style['oTransform'] = "translate(0px, -360px)";
/*
